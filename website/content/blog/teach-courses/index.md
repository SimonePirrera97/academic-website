...
{{< cite page="/publications/single-iteration-mpc-wave-energy-converters" view="citation" >}}

You can also use the default view by omitting the view parameter:

{{< cite page="/publications/constrained-optimization-feedback-control-lagrange-multipliers" >}}

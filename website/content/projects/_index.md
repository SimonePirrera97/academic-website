...
<section class="project-panel-list" aria-label="Projects">
  <a class="project-panel project-panel-link" href="/projects/swell/">
    ...
    <div class="project-panel-body">
      ...
      <p>The project develops data-driven model predictive control methods for wave energy converters, combining hydrodynamic modeling, efficient control design, experimental validation, and open-source software.</p>
    </div>
  </a>
</section>
